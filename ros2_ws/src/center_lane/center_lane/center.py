...
class CenterNode(Node):
    def __init__(self):
        ...
        self.get_split_left = self.create_subscription(Float32MultiArray, "/laneatt/left_lane", self.lane_callback,1)
        self.get_split_right = self.create_subscription(Float32MultiArray, "/laneatt/right_lane", self.lane_callback,  1)
