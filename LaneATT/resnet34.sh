...
python main.py train --exp_name LaneATTresnet34Bdd100k_False --cfg /cfgs/laneatt_bdd100k_resnet34.yml # (LaneNet310) [anindra@gnode021 LaneATT]$ sbatch resnet34.sh Submitted batch job 340868 FALSE
